...
cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('#btn-go').on('click', () => {
    ...
    fetch('/', {
        ...
        .then(res => res.json())
        .then(music => {
            const [img, info] = cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('.music').show().children();
            cash_dom__WEBPACK_IMPORTED_MODULE_0___default()(img).children().first().attr('src', music.artwork);
            cash_dom__WEBPACK_IMPORTED_MODULE_0___default()(info)
                .find('.genre')
                .text(`#${music.genre || 'NoGenre'} `);
            cash_dom__WEBPACK_IMPORTED_MODULE_0___default()(info).find('.title').text(music.title);
            cash_dom__WEBPACK_IMPORTED_MODULE_0___default()(info)
                .find('.artist')
                .text(`${music.artist || 'Unknown Artist'} • ${music.album || 'Unknown Album'}`);
            cash_dom__WEBPACK_IMPORTED_MODULE_0___default()(info).find('.year').text(music.year);

            cash_dom__WEBPACK_IMPORTED_MODULE_0___default()('.download').show().children().first().attr('href', '/');
        })
